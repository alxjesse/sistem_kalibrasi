<div class="container-fluid">
    ...
    <?php foreach ($users as $user) : ?>
        ...
        <form method="post" action="<?php echo base_url('administrator/users/update_aksi') ?>">
            ...
            <div class="form-group">
                <label>NIP</label>
                <input type="text" name="nip" placeholder="Masukkan NIP" class="form-control" value="<?php echo $user->nip ?>">
            ...
            <div class="form-group">
                ...
                <select name="level" class="form-control">
                    ...
                    <?php
                        } elseif ($level == 'kalibrator') {
                            ?>
                        <option value="admin">Admin</option>
                        <option value="kalibrator" selected>Kalibrator</option>
                        <option value="user">SuperUser</option>
                    ...
                    <?php
                        ...
                        <option value="admin">Admin</option>
                        <option value="kalibrator">Kalibrator</option>
                        <option value="user" selected>SuperUser</option>
