<div class="container-fluid">
    ...
    <?php echo anchor('administrator/users/tambah_users', '<button class ="btn btn-sm btn-primary mb-3">
    <i class="fas fa-plus fa-sm"></i> Tambah Users</button>') ?>
        ...
        foreach ($users as $user) : ?>
            ...
            <tr>
                ...
                <td widht="20px"><?php echo anchor(
                                            'administrator/users/update/' . $user->id,
                                            '<div class ="btn btn-sm btn-primary"><i class="fa fa-edit"></i></div>'
                                        ) ?></td>
                <td widht="20px"><?php echo anchor(
                                            'administrator/users/delete/' . $user->id,
